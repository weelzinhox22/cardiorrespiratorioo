      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="mb-6 sm:mb-8 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center mb-4 sm:mb-6">
            <div className="p-3 sm:p-4 rounded-2xl bg-gradient-to-r from-green-500 to-emerald-500 shadow-lg sm:mr-6 mb-4 sm:mb-0 mx-auto sm:mx-0 w-16 h-16 sm:w-auto sm:h-auto flex items-center justify-center">
              <Activity className="h-8 w-8 sm:h-12 sm:w-12 text-white" />
            </div>
        ...
        <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm animate-slide-up">
          ...
          <CardContent className="prose prose-sm sm:prose-lg max-w-none">
            <div className="space-y-6 text-gray-700 leading-relaxed">
              <section>
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3">Aula de cárdio Prescrição para cardiopata</h3>
                <p>
